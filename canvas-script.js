...
function drawLight(cX, cY, color) {
  ...
  ctx.globalAlpha = 0.3
  ctx.beginPath();
  ctx.arc(cX, cY, h/5, 0, 2 * Math.PI);
  ctx.fill();

  ctx.beginPath();
  ctx.arc(cX, cY, (h/5)*(randInRange(0.85,0.95)), 0, 2 * Math.PI);
  ctx.fill();

  ctx.beginPath();
  ctx.arc(cX, cY, (h/5)*(randInRange(0.7,0.85)), 0, 2 * Math.PI);
  ctx.fill();

  ctx.globalAlpha = 0.5
  ctx.beginPath();
  ctx.arc(cX, cY, (h/5)*(randInRange(0.5,0.65)), 0, 2 * Math.PI);
  ctx.fill();

  ctx.beginPath();
  ctx.arc(cX, cY, (h/5)*(randInRange(0.25,0.45)), 0, 2 * Math.PI);
  ctx.fill();

  ctx.globalAlpha = 1
  ctx.beginPath();
  ctx.arc(cX, cY, (h/5)*(0.2), 0, 2 * Math.PI);
  ctx.fill();
}
